      ...
      if (auth) {
        auth.onAuthStateChanged(function (user) {
          ...
          fetchRole(user).then(function (role) {
            ...
            // 'staff' = ค่าที่ค้างจากโครงสร้างเดิม · 'user' = บัญชีทั่วไปในโครงสร้างใหม่
            showDenied(auth, (role === 'user' || role === 'staff')
              ? 'บัญชี <b>' + name + '</b> เป็นระดับผู้ใช้ทั่วไป — เครื่องมือนี้เฉพาะผู้ดูแลระบบ<br>'
                + 'ถ้าคุณเป็นผู้ควบคุมของโครงการ ให้ใช้ Dashboard หรือแอปสำรวจแทน'
