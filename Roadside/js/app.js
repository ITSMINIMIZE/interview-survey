...
const App = {
    ...
    return `<div class="page container">
      ...
      ${allSts.length === 0 ? `
        <div class="empty">
          ...
          <p>${this._canManage() ? 'กดปุ่มด้านล่างเพื่อเพิ่มจุดสำรวจ หรือดึงข้อมูลที่สร้างไว้แล้วจากระบบ' : 'กด "ดึงข้อมูล" เพื่อโหลดจุดสำรวจที่ผู้ดูแลสร้างไว้'}</p>
  ...
  openAddStation() {
    ...
    setTimeout(() => document.getElementById('s_stName')?.focus(), 50);
  },
