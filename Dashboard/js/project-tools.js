...
const ProjectTools = {
  ...
  _renderMore() {
    ...
    this._g('ptBody').innerHTML = `
      ...
      ${this._apps.home ? t('seed-home.html', '🏘', 'สร้างข้อมูลทดสอบ Home', 'สร้างครัวเรือน/สมาชิก/เที่ยวเดินทางจำลอง สำหรับลองระบบ', '⚠ ใช้กับโครงการทดสอบเท่านั้น') : ''}
      ${this._apps.roadside ? t('seed-roadside.html', '🚦', 'สร้างข้อมูลทดสอบ Roadside', 'สร้างจุดสำรวจ + การสัมภาษณ์จำลอง', '⚠ ใช้กับโครงการทดสอบเท่านั้น') : ''}
